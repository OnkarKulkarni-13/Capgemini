...
public class HomeController {
	...
	public ModelAndView getIndex() {
		...
		return mymv;
			...
			//".GET" method is thrown by "webpage" to show ".jsp" file 
			//".POST" method is used to throw the "HTML FORM"
			@RequestMapping(value="/addpetdetails",method=RequestMethod.POST)     //Instead of "value" you can also use "path"
	...
	@RequestMapping(value="/addcustomerdetails", method=RequestMethod.POST)  //Instead of "value" you can also use "path"
