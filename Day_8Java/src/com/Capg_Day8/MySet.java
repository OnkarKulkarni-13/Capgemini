...
public class MySet {
	...
	public static void main(String args[]) {
		...
		employeeList.add(new Employee(10, "Onkar", 100.0f));
		employeeList.add(new Employee(1, "Vyankatsh", 100.0f));
		employeeList.add(new Employee(2, "Ram", 100.0f));
		employeeList.add(new Employee(100, "Sham", 100.0f));
		...
		employeeList.add(new Employee(10, "Onkar", 100.0f));
		employeeList.add(new Employee(1, "vyankatesh", 100.0f));
		employeeList.add(new Employee(2, "Ram", 100.0f));
		employeeList.add(new Employee(100, "Anil", 100.0f));
		employeeList.add(new Employee(5, "Sham", 100.0f));
		employeeList.add(new Employee(100, "Anil", 100.0f));
		employeeList.add(new Employee(5, "Zee", 100.0f));
